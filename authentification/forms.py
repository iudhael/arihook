...
class CreateUserform(UserCreationForm):
    """
    first_name = forms.CharField(label='first_name',max_length=50, min_length=2,required=True, widget=forms.TextInput(attrs={
        'class' : 'form-control',
        'placeholder' : 'first_name',
        'autocomplete' : 'on',
    }))

    last_name = forms.CharField(label='last_name',max_length=50, min_length=2,required=True, widget=forms.TextInput(attrs={
        'class' : 'form-control',
